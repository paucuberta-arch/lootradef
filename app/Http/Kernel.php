...
use App\Http\Middleware\ShareCampaignData;
use App\Http\Middleware\ThrottleCampaignGameplay;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            CaptureCampaignAttribution::class,
            ShareCampaignData::class,
            ThrottleCampaignGameplay::class,
        ],
