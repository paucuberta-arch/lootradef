...
function sportsbook() {
    return {
        ...
        select(match,choice){if(match.betting_open){this.selected={match,choice,requestToken:crypto.randomUUID()};this.message='';}}, money(v){return new Intl.NumberFormat('es-ES',{style:'currency',currency:'EUR'}).format(Number(v)||0)},
