...
@push('scripts')
<script>
function originalGame(){return{mode:@js($game['mode']),initialCard:@js($initialCard),saldo:{{ $gameBalance }},apuesta:2,choice:@js(match($game['mode']){'dice'=>'high','hilo'=>'higher','coin'=>'heads','baccarat'=>'player','nebula'=>'violet','mines'=>3,default=>null}),numbers:[],playing:false,result:null,error:'',rotation:0,reducedMotion:window.matchMedia('(prefers-reduced-motion: reduce)').matches,
