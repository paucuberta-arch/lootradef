...
function pokerAllIn() {
    return {
        ...
        get message() {
            ...
            if (this.result.outcome === 'win') return `Has ganado ${this.money(this.result.ganancia)} con ${this.result.player_hand}`;
            return this.result.outcome === 'tie' ? `Empate · retorno ${this.money(this.result.ganancia)}` : `Gana el dealer con ${this.result.dealer_hand}`;
        },
