...
<div class="grid grid-cols-1 min-[480px]:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    @php
        $cards = [
            ...
            ['label' => 'Partidas casino hoy', 'value' => number_format($stats['partidas_hoy']), 'icon' => 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z', 'color' => 'brand'],
...
@if($user->can('reviews.view') || $user->can('feedback.view'))
