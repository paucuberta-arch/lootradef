...
<a href="{{ ($rickyeditActiveChallenge ?? null) ? route('rickyedit.ranking') : route('rickyedit.landing') }}" data-campaign-click class="fixed bottom-4 right-4 z-40 flex min-h-12 items-center gap-2 rounded-full border border-fuchsia-300/30 bg-slate-950/95 px-4 py-3 text-xs font-black text-white shadow-2xl shadow-fuchsia-500/20 backdrop-blur sm:bottom-6 sm:right-6" aria-label="Abrir Reto RickyEdit">
